<?php
  ...
  $db = new DB();
	  ...
	  if (isset($_POST['submitProduit'])) {
        ...
        $filename = "produits/".$prod_name.".jpg";

	    if (move_uploaded_file($tmp_name,$filename) ) {
            $idProvider=$_SESSION['id_four'];
	      $sql = "INSERT INTO produits(nom_prod,image,categorie,stock,date_exp,prix,description,id_four) VALUES ('$prod_name','$filename','$categorie','$quantite','$date','$prix','$description','$idProvider')";

	      $db->update($sql);
          header('Location:../market/products-list.php');
...
<br><br><br><br><br><br><br>
	...
	<table>
		...
		<tr>
			...
			<td>
				<div class="mdl-textfield mdl-js-textfield">
				  <input class="mdl-textfield__input" type="file" name="image" required>
 				</div>
			</td>
		</tr>
<!--
