<?php 
 ...
 $idProduct = $_GET['id_prod'];
 $DB = new DB();   
 $products =  $DB->query("SELECT * FROM produits WHERE id_prod= $idProduct AND id_four= $idProvider");
                ...
                <div class="col-sm-12 ct-u-marginBottom40">
                    <div id="synced-1" class="ct-slick--synced ct-slick--synced--type1">
                        <div class="ct-slick ct-js-slick ct-js-slick-for" data-items="1" data-arrows="false" data-draggable="false" data-touchMove="false">
                            <div class="item"><img src="assets/images/demo-content/radish01.jpg" alt=""/></div>
                            <div class="item"><img src="assets/images/demo-content/radish02.jpg" alt=""/></div>
                            <div class="item"><img src="assets/images/demo-content/radish03.jpg" alt=""/></div>
                            <div class="item"><img src="assets/images/demo-content/radish04.jpg" alt=""/></div>
                            <div class="item"><img src="assets/images/demo-content/radish05.jpg" alt=""/></div>
                        </div>
                ...
                <div class="col-sm-12">
                    <div class="ct-portfolio-singleItem">
                        ...
                        <div class="ct-portfolio-SingleItem-title">
                            <h3><span><?=$prod->nom_prod;?></span></h3>
                        </div>
                        
                        <div class="ct-portfolio-SingleItem-text">
                         <div class="col-xs-6">
                           Votes <p class="ct-u-colorBrownDark2 text-uppercase ct-fw-600 ct-u-marginBottom40"><?= $prod->nb_votes;?></p>
                         </div>
                         <div class="col-xs-6">
                          Rating <p class="ct-u-colorBrownDark2 text-uppercase ct-fw-600 ct-u-marginBottom40"><?= $prod->rate;?></p>
                         </div>
                        </div>
                        ...
                        <div class="ct-portfolio-SingleItem-types">
                            <p>
                                <strong>Category:</strong> <?=$prod->categorie;?>
                            </p>
                        </div>
                        ...
                        <div class="ct-portfolio-SingleItem-types">
                            <p>
                                <strong>Expiration date:</strong> <?=$prod->date_exp;?>
                            </p>
                        </div>
